...
static int sensor_mipi_line = 1;
module_param(sensor_mipi_line, int, S_IRUGO);
MODULE_PARM_DESC(sensor_mipi_line, "Sensor mipi line set interface");
...
struct tx_isp_mipi_bus sc301IoT_mipi_1line={
...
struct tx_isp_mipi_bus sc301IoT_mipi_2line={
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 405,
	.lans = 2,
	.settle_time_apative_en = 0,

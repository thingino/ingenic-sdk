...
static struct regval_list sensor_init_regs_2304_1296_20fps_mipi[] = {
	{0x12, 0x70},
	{0x48, 0x8a},
	{0x48, 0x0a},
	{0x0e, 0x11},
...
static struct regval_list sensor_init_regs_1920_1080_20fps_mipi[] = {
	{0x12, 0x70},
	{0x48, 0x8a},
	{0x48, 0x0a},
	{0x0e, 0x11},
...
static struct regval_list sensor_init_regs_1440_1440_15fps_mipi[] = {
	{0x12, 0x70},
	{0x48, 0x8a},
	{0x48, 0x0a},
	{0x0e, 0x11},
...
static struct tx_isp_sensor_win_setting sensor_win_sizes[] = {
	/* [0] 1440*1440 @15fps (preview mode) */
	{
		...
		.regs = sensor_init_regs_1440_1440_15fps_mipi,
	},
	/* [1] 2304*1296 @20fps (vendor native, default main) */
	{
		...
		.mbus_code = V4L2_MBUS_FMT_SGBRG10_1X10,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.regs = sensor_init_regs_2304_1296_20fps_mipi,
	},
	/* [2] 1920*1080 @20fps */
	{
		.width = 1920,
		...
		.mbus_code = V4L2_MBUS_FMT_SGBRG10_1X10,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.regs = sensor_init_regs_1920_1080_20fps_mipi,
	},
};
...
static int sensor_set_fps(struct tx_isp_subdev *sd, int fps)
{
	struct tx_isp_sensor *sensor = sd_to_sensor_device(sd);
	int ret = 0;
	unsigned int sclk = SENSOR_SUPPORT_SCLK_4M;
	unsigned int hts = 0;
	unsigned int vts = 0;

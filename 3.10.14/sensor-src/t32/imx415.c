 ...
 *   0           3840x2160      20          mipi       linear    10      20
 *
 * @I2C addr: 0x1a
 *
 * @FSync: None
...
static struct regval_list imx415_init_regs_3840_2160_20fps_mipi[] = {
	...
	{0x300A, 0x5B},
	{0x301C, 0x04},
	{0x3024, 0xB2},//vts = 0x8b2 = 2262
	{0x3025, 0x08},//
	{0x3028, 0x84},//hts = 0x684 = 1668
	{0x3029, 0x06},//
	{0x3031, 0x00},
	{0x3032, 0x00},
	{0x3033, 0x05},
...
static int imx415_setting_select(struct tx_isp_subdev *sd, int deboot)
{
    ...
    case 0:
        ...
        imx415_attr.integration_time.max = 2262 - 8;
        imx415_attr.integration_time.min = 4;
        imx415_attr.integration_time.apply_delay = 2;

        imx415_attr.total_width = 1168;
        imx415_attr.total_height = 2262;

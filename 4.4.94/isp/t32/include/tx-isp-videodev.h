...
struct tisp_buffer {
	...
	uint32_t                        reserved2;
	uint32_t                        reserved2_len;
	uint32_t                        reserved;
	uint32_t                        reserved_len;
};

struct tisp_buffer_reserved {
	uint16_t ivdc;
	uint8_t i_frame_flag;
};
...
enum oneshot_control_value {
	TISP_ONESHOT_DISABLE = 0,
	TISP_ONESHOT_ENABLE,
	TISP_ONESHOT_TICK,
	TISP_ONESHOT_TICK_NOBLOCK,
	TISP_ONESHOT_CONTROL_END,
};

#define BASE_DEVICE_PRIVATE 	        	0
#define BASE_TUNING_PRIVATE			100
#define BASE_IVDC_PRIVATE			110
#define BASE_FS_PRIVATE 			130
#define BASE_LDC_PRIVATE        		180
#define BASE_DEVICE_PRIVATE1 			200
...
#define TISP_VIDIOC_SET_ISP_MEM_INFO                           _IOW('T', BASE_DEVICE_PRIVATE + 15, struct isp_buf_info)
#define TISP_VIDIOC_GET_ISP_MEM_INFO                           _IOW('T', BASE_DEVICE_PRIVATE + 16, struct isp_buf_info)
...
#define TISP_VIDIOC_SET_MULTISENSOR_MODE                         _IOWR('T',BASE_DEVICE_PRIVATE + 21, int)
#define TISP_VIDIOC_SET_MULTISENSOR_BUF_INFO                     _IOWR('T',BASE_DEVICE_PRIVATE + 22, struct isp_buf_info)
#define TISP_VIDIOC_GET_MULTISENSOR_BUF_INFO                     _IOW('T', BASE_DEVICE_PRIVATE + 23, struct isp_buf_info)
...
#define TISP_VIDIOC_SET_PM_CONTROL                                     _IOWR('T',BASE_DEVICE_PRIVATE + 49, int)
#define TISP_VIDIOC_GET_PM_CONTROL                                     _IOWR('T',BASE_DEVICE_PRIVATE + 50, int)
#define TISP_VIDIOC_SET_PM_ALL_DONE                                    _IOWR('T',BASE_DEVICE_PRIVATE + 51, int)
#define TISP_VIDIOC_GET_RAW_CONTROL                                    _IOWR('T',BASE_DEVICE_PRIVATE + 52, int)
#define TISP_VIDIOC_GET_NV12_CONTROL                                   _IOWR('T',BASE_DEVICE_PRIVATE + 53, int)
#define TISP_VIDIOC_SET_AE_START_EV                                   _IOWR('T',BASE_DEVICE_PRIVATE + 54, int)
#define TISP_VIDIOC_GET_AE_START_EV                                   _IOWR('T',BASE_DEVICE_PRIVATE + 55, int)
#define TISP_VIDIOC_SET_ISP_IPC_MEM_INFO                           _IOW('T', BASE_DEVICE_PRIVATE + 56, struct isp_buf_info)
#define TISP_VIDIOC_GET_ISP_IPC_MEM_INFO                           _IOW('T', BASE_DEVICE_PRIVATE + 57, struct isp_buf_info)
#define TISP_VIDIOC_MEMORY_MALLOC                           		_IOW('T', BASE_DEVICE_PRIVATE + 58, struct isp_buf_info)
...
#define TISP_VIDIOC_MAX_STRIDE                                  _IOWR('T', BASE_IVDC_PRIVATE + 7, int)
#define TISP_VIDIOC_SET_MEM_LINE                                _IOWR('T', BASE_IVDC_PRIVATE + 8, int)
...
#define TISP_VIDIOC_SET_FRAME_FORMAT                            _IOWR('T', BASE_FS_PRIVATE + 1, int)
#define TISP_VIDIOC_GET_FRAME_FORMAT                            _IOWR('T', BASE_FS_PRIVATE + 2, int)
...
#define TISP_VIDIOC_SNAP_RAW                          _IOWR('T', BASE_FS_PRIVATE + 12, int)
#define TISP_VIDIOC_CLOSE_MSCA                          _IOWR('T', BASE_FS_PRIVATE + 13, int)

//ldc ioctl
#define TISP_VIDIOC_SET_LDC_INIT                                       _IOWR('T', BASE_LDC_PRIVATE + 1, int)
#define TISP_VIDIOC_SET_LDC_CONTROL                                    _IOWR('T', BASE_LDC_PRIVATE + 2, int)
#define TISP_VIDIOC_GET_LDC_CONTROL                                    _IOWR('T', BASE_LDC_PRIVATE + 3, int)
#define TISP_VIDIOC_LDC_SET_MODE                                       _IOWR('T', BASE_LDC_PRIVATE + 4, int)
...
#define TISP_VIDIOC_DEFAULT_BIN                                   _IOWR('T',BASE_DEVICE_PRIVATE1 + 1, int)
#define TISP_VIDIOC_SET_WDR_ENABLE                                   _IOWR('T',BASE_DEVICE_PRIVATE1 + 2, int)
#define TISP_VIDIOC_GPIO_STATE_SWITCH				_IOWR('T', BASE_DEVICE_PRIVATE1 + 3, int)
#define TISP_VIDIOC_GPIO_STATE_SWITCH_TRIGGER			_IOWR('T', BASE_DEVICE_PRIVATE1 + 4, int)
#define TISP_VIDIOC_SET_FRAME_DROP_ONCE                               _IOWR('T',BASE_DEVICE_PRIVATE1 + 5, int)
#define TISP_VIDIOC_GET_FRAME_DROP_ONCE                               _IOWR('T',BASE_DEVICE_PRIVATE1 + 6, int)

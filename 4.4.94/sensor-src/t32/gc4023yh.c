...
struct again_lut {
	...
	unsigned char reg1466;
	unsigned char reg1467;
	unsigned char reg1468;
	unsigned char regb8;
	unsigned char regb9;
	unsigned char reg2cd;
	unsigned int gain;
};

struct again_lut gc4023_again_lut[] = {
   //index 0x614 0615  0218  1466  1467  1468  00b8  00b9  02cd    |实际倍数|Again dB|
	{0x00, 0x00, 0x00, 0x00, 0x18, 0x29, 0x29, 0x01, 0x00, 0x92, 0},       //1.000000
	{0x01, 0x80, 0x02, 0x00, 0x18, 0x2a, 0x2a, 0x01, 0x0b, 0x92, 14995},   //1.171875
	{0x02, 0x01, 0x00, 0x00, 0x18, 0x2a, 0x2a, 0x01, 0x19, 0x92, 30108},   //1.375000
	{0x03, 0x81, 0x02, 0x00, 0x18, 0x2b, 0x2b, 0x01, 0x2a, 0x92, 45903},   //1.625000
	{0x04, 0x02, 0x00, 0x00, 0x18, 0x2b, 0x2b, 0x02, 0x00, 0x92, 60217},   //1.890625
	{0x05, 0x82, 0x02, 0x00, 0x18, 0x2c, 0x2c, 0x02, 0x17, 0x92, 76013},   //2.234375
	{0x06, 0x03, 0x00, 0x00, 0x18, 0x2d, 0x2d, 0x02, 0x33, 0x92, 92920},   //2.671875
	{0x07, 0x83, 0x02, 0x00, 0x18, 0x2f, 0x2f, 0x03, 0x14, 0x92, 109138},   //3.171875
	{0x08, 0x04, 0x00, 0x00, 0x18, 0x30, 0x30, 0x04, 0x00, 0x92, 123779},   //3.703125
	{0x09, 0x80, 0x02, 0x20, 0x18, 0x25, 0x25, 0x04, 0x2f, 0x99, 140885},   //4.437500
	{0x0a, 0xb0, 0x04, 0x20, 0x18, 0x25, 0x25, 0x05, 0x26, 0x99, 160911},   //5.484375
	{0x0b, 0x58, 0x06, 0x20, 0x1b, 0x27, 0x27, 0x06, 0x28, 0x99, 176062},   //6.437500
	{0x0c, 0x00, 0x08, 0x20, 0x1b, 0x27, 0x27, 0x08, 0x00, 0x99, 193606},   //7.750000
	{0x0d, 0x40, 0x09, 0x20, 0x1f, 0x2d, 0x2d, 0x09, 0x1e, 0x99, 207743},   //9.000000
	{0x0e, 0xa0, 0x0c, 0x20, 0x14, 0x1e, 0x1e, 0x12, 0x3d, 0x99, 284852},   //20.343750
	{0x0f, 0x01, 0x0c, 0x20, 0x10, 0x19, 0x19, 0x16, 0x19, 0x99, 301640},   //24.296875
	{0x10, 0xa1, 0x0c, 0x20, 0x10, 0x1a, 0x1a, 0x1a, 0x22, 0x99, 315579},   //28.156250
	{0x11, 0x02, 0x0c, 0x20, 0x10, 0x1a, 0x1a, 0x20, 0x00, 0x99, 328231},   //32.187500
	{0x12, 0xa2, 0x0c, 0x20, 0x10, 0x1a, 0x1a, 0x25, 0x3a, 0x99, 342714},   //37.515625
	{0x13, 0x03, 0x0c, 0x20, 0x10, 0x1b, 0x1b, 0x2c, 0x33, 0x99, 357721},   //43.968750
	{0x14, 0xa3, 0x0c, 0x20, 0x10, 0x1c, 0x1c, 0x35, 0x05, 0x99, 372698},   //51.515625
	{0x15, 0x04, 0x0c, 0x20, 0x10, 0x1d, 0x1d, 0x40, 0x00, 0x99, 386197},   //59.421875
...
static struct regval_list gc4023_init_regs_2560_1440_30fps_mipi[] = {
	//version:1.1.0
	//<MODE_1 type="GC4023_YH_MIPI_2560x1440_30fps_raw10_2lane_HK_02">
	//mclk 27Mhz
	//mipi 702Mbps/lane
	//vts = 1500
	//window 2560 1440
...
static int gc4023_set_expo(struct tx_isp_subdev *sd, int value)
{
	...
	ret = gc4023_write(sd, 0x1466, val_lut[again].reg1466);
    ...
    ret = gc4023_write(sd, 0x02cd, val_lut[again].reg2cd);
    return ret;
}
#else
...
static int gc4023_set_analog_gain(struct tx_isp_subdev *sd, int value)
{
	...
	ret = gc4023_write(sd, 0x1466, val_lut[value].reg1466);
    ...
    ret = gc4023_write(sd, 0x02cd, val_lut[value].reg2cd);
    return ret;
}
#endif /* SENSOR_EXPO */

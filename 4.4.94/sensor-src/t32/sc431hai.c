 ...
 *  0           2560*1440       30        mipi_2lane    linear  10        30                 support
 *  1           1280*720        20        mipi_2lane    linear  10        20                 none
 *
 * @I2C addr:0x30, 0x32
 *
 * @FSync:none
...
static struct regval_list sc431hai_init_regs_1280_720_20fps_mipi[] = {
	{0x0100,0x00},
	{0x36e9,0x80},
	{0x37f9,0x80},
	{0x3018,0x3a},
...
static struct tx_isp_sensor_win_setting sc431hai_win_sizes[] = {
	...
	/* 1280*720 [1] */
	{
		...
		.mbus_code      = TISP_VI_FMT_SBGGR10_1X10,
		.colorspace     = TISP_COLORSPACE_SRGB,
		.regs           = sc431hai_init_regs_1280_720_20fps_mipi,
	},
};
...
static int sc431hai_setting_select(struct tx_isp_subdev *sd, int deboot)
{
	...
	case 1:
		...
		sc431hai_attr.integration_time.value = 0xbad / 2;
		sc431hai_attr.integration_time.max = 4200 - 6;
		sc431hai_attr.integration_time.min = 2;
		sc431hai_attr.integration_time.apply_delay = 2;

		sc431hai_attr.total_width = 1500;
		sc431hai_attr.total_height = 4200;
		...
		memcpy((void *)(&(sc431hai_attr.mipi)), (void *)(&sc431hai_mipi_linear), sizeof(sc431hai_attr.mipi));
		sc431hai_attr.mipi.image_twidth = 1280;
		sc431hai_attr.mipi.image_theight = 720;
		break;
	default:

 ...
 *  1           3840*2160       20        mipi_4lane    linear  10        20       null
 *
 * @I2C addr:0x35,0x36
 *
 * @FSync:none
...
static struct regval_list cv8001_init_regs_3840_2160_20fps_mipi_4lane[] = {
    //CV8001_3840_2160_Full_linear_NoBin_NoBin_10bit_4Lane528M_20fps_24Mhz_release
    {0x3028, 0x98},
    {0x3029, 0x12},
    {0x3915, 0x00},
    {0x3220, 0x08},
...
static struct tx_isp_sensor_win_setting cv8001_win_sizes[] = {
    ...
    },
    {
        ...
        .mbus_code      = TISP_VI_FMT_SRGGB10_1X10,
        .colorspace     = TISP_COLORSPACE_SRGB,
        .regs           = cv8001_init_regs_3840_2160_20fps_mipi_4lane,
    },
};
...
static int cv8001_setting_select(struct tx_isp_subdev *sd, int deboot)
{
    ...
    case 1:
        ...
        cv8001_attr.integration_time.value = 0xb60;
        cv8001_attr.integration_time.max = 4760 - 8;
        cv8001_attr.integration_time.min = 2;
        cv8001_attr.integration_time.apply_delay = 2;

        cv8001_attr.total_width = 315;
        cv8001_attr.total_height = 4760;
        ...
        memcpy((void *)(&(cv8001_attr.mipi)), (void *)(&cv8001_mipi_linear), sizeof(cv8001_attr.mipi));
        cv8001_attr.mipi.clk = 528;
        cv8001_attr.mipi.lans = 4;
        break;
    default:

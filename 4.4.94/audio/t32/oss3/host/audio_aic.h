...
static void inline i2s_set_reg(struct audio_aic_device *i2s_dev, unsigned int addr, unsigned int val, unsigned int mask, unsigned int offset)
{
...
#define __i2s_slave_clkset(i2s_dev)        \
	do {                                            \
		i2s_set_reg(i2s_dev, AICFR,0,I2S_RMASTER_MASK,I2S_RMASTER_OFFSET); \
		i2s_set_reg(i2s_dev, AICFR,0,I2S_TMASTER_MASK,I2S_TMASTER_OFFSET); \
	}while(0)

#define __i2s_master_clkset(i2s_dev)        \
	do {                                            \
		i2s_set_reg(i2s_dev, AICFR,1,I2S_RMASTER_MASK,I2S_RMASTER_OFFSET); \
		i2s_set_reg(i2s_dev, AICFR,1,I2S_TMASTER_MASK,I2S_TMASTER_OFFSET); \
	}while(0)
